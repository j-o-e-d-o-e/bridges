...
public class GameInfo {
    ...
    public static int ISLE_SIZE = 90; // needs to be even
    public static int ONE_TILE = ISLE_SIZE + CONTAINER_OFFSET * 2;
    // bridge-overlap into isle-tile
    public static int BRIDGE_OVERLAP = (ONE_TILE - ISLE_SIZE) / 2;
    ...
    public static int BRIDGE_OFFSET = 4;
